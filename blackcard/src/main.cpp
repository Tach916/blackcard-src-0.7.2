...
#if defined(NDEBUG)
# error "BlackCard cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf63d0a558a662aced9bfd2217979736c3c8ac590da7b586e4a8d3d68ec2163bd");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BlackCard: starting difficulty is 1 / 2^12
...
{
    // BlackCard: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // BlackCard: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // BlackCard: 5 min
static const int64 nTargetSpacing = 1 * 60; // BlackCard: 1 Min
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BlackCard: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BlackCard: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf63d0a558a662aced9bfd2217979736c3c8ac590da7b586e4a8d3d68ec2163bd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "It's everywhere you want to be!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("456984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1466057412;
        ...
        assert(block.hashMerkleRoot == uint256("0x87df627d651702abcff0b416cd92cb03adfa0152053b7fcb4ca291bee082287d"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // BlackCard: increase each by adding 2 to bitcoin's value.
...
void static BlackCardMiner(CWallet *pwallet)
{
    printf("BlackCardMiner started\n");
    ...
    {
        printf("BlackCardMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BlackCardMiner, pwallet));
}
